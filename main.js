...
//2.读excel表格“建议上线景点”前300条，取出名字
var suggest_name = util.getSuggestName("./test.xlsx", 1, 300);

//3.从原始数据TXT文件中，找出这300个名字对应的父点bid
...
var bids = util.getBarinfo_free(combine_bids, './top.txt');
